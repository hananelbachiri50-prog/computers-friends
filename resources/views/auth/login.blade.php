...
<head>
    ...
    <title>Connexion | Computer Friends</title>
...
<body class="min-h-screen flex items-center justify-center py-12 px-4">
    ...
    <div class="relative z-10 w-full max-w-lg">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-zinc-400 mt-2">Connectez-vous à votre compte</p>
        </div>

        <!-- Form Card -->
        <div class="bg-zinc-900/80 backdrop-blur-xl border border-zinc-800 rounded-3xl p-8 md:p-10 shadow-2xl">
            <h2 class="text-2xl font-bold text-white mb-6 text-center">Bienvenue</h2>
            ...
            <div class="mt-6 text-center">
                <p class="text-zinc-400 text-sm">
                    ...
                    <a href="{{ route('register') }}" class="text-yellow-500 hover:text-yellow-400 font-medium transition-colors">
                        S'inscrire
                    </a>
                </p>
            </div>
